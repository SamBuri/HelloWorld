...
Public Class frmDoctorIPDItems
...
#End Region
    ...
    Private Sub frmDoctorIPDItems_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            Me.ShowDoctorIPDItems(Today.AddDays(-1), Today)
        ...
        Try
            ...
            Select Case True
                ...
                Case Me.rdoGetDoctor.Checked
                    ...
                    Me.ShowDoctorIPDItems(startDate, endDate)
                ...
                Case Me.rdoGetAll.Checked
                    ...
                    '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
                    Me.ShowDoctorIPDItems(Nothing, Nothing)
    ...
    Private Sub ShowDoctorIPDItems(ByVal startDate As Nullable(Of Date), ByVal endDate As Nullable(Of Date))
        ...
        Try
            ...
            If (startDate IsNot Nothing) And (endDate IsNot Nothing) Then
                ...
                Select Case True
                    ...
                    Case Me.doctorItemCategory.Equals(ClinicMaster.AlertItemCategory.Test)
                        doctorItems = oIPDItems.GetDoctorIPDItems(oItemCategoryID.Test, CurrentUser.LoginID, showOnlyPending, startDate, endDate).Tables("IPDItems")

                    Case Me.doctorItemCategory.Equals(ClinicMaster.AlertItemCategory.Drug)
                        doctorItems = oIPDItems.GetDoctorIPDItems(oItemCategoryID.Drug, CurrentUser.LoginID, showOnlyPending, startDate, endDate).Tables("IPDItems")

                    Case Me.doctorItemCategory.Equals(ClinicMaster.AlertItemCategory.Radiology)
                        doctorItems = oIPDItems.GetDoctorIPDItems(oItemCategoryID.Radiology, CurrentUser.LoginID, showOnlyPending, startDate, endDate).Tables("IPDItems")

                    Case Me.doctorItemCategory.Equals(ClinicMaster.AlertItemCategory.Procedure)
                        doctorItems = oIPDItems.GetDoctorIPDItems(oItemCategoryID.Procedure, CurrentUser.LoginID, showOnlyPending, startDate, endDate).Tables("IPDItems")

                    Case Else : doctorItems = oIPDItems.GetDoctorIPDItems(String.Empty, CurrentUser.LoginID, showOnlyPending, startDate, endDate).Tables("IPDItems")
            ...
            Else
                Select Case True
                    ...
                    Case Me.doctorItemCategory.Equals(ClinicMaster.AlertItemCategory.Test)
                        doctorItems = oIPDItems.GetDoctorIPDItems(oItemCategoryID.Test, CurrentUser.LoginID, showOnlyPending).Tables("IPDItems")

                    Case Me.doctorItemCategory.Equals(ClinicMaster.AlertItemCategory.Drug)
                        doctorItems = oIPDItems.GetDoctorIPDItems(oItemCategoryID.Drug, CurrentUser.LoginID, showOnlyPending).Tables("IPDItems")

                    Case Me.doctorItemCategory.Equals(ClinicMaster.AlertItemCategory.Radiology)
                        doctorItems = oIPDItems.GetDoctorIPDItems(oItemCategoryID.Radiology, CurrentUser.LoginID, showOnlyPending).Tables("IPDItems")

                    Case Me.doctorItemCategory.Equals(ClinicMaster.AlertItemCategory.Procedure)
                        doctorItems = oIPDItems.GetDoctorIPDItems(oItemCategoryID.Procedure, CurrentUser.LoginID, showOnlyPending).Tables("IPDItems")

                    Case Else : doctorItems = oIPDItems.GetDoctorIPDItems(String.Empty, CurrentUser.LoginID, showOnlyPending).Tables("IPDItems")
    ...
    Private Sub dgvdoctorItems_CellDoubleClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvDoctorItems.CellDoubleClick
        ...
        Try
            ...
            Dim roundNo As String = Me.dgvDoctorItems.Item(Me.colRoundNo.Name, e.RowIndex).Value.ToString()
