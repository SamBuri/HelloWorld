...
Public Class frmImportDrugs

#Region " Fields "
    Private _ErrorLog As New StringBuilder(String.Empty)
#End Region

    Private Sub frmImportDrugs_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub fbnImport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles fbnImport.Click
        ...
        Try
            ...
            Dim range As String = ""
            Dim where As String = "where [Drug No] is not null"
            ...
            For pos As Integer = 0 To importedData.Rows.Count - 1
                ...
                With Me.dgvImportedData
                    ...
                    .Item(Me.colDrugNo.Name, pos).Value = StringMayBeEnteredIn(row, "Drug No")
                    .Item(Me.colDrugName.Name, pos).Value = StringMayBeEnteredIn(row, "Drug Name")
                    .Item(Me.colAlternateName.Name, pos).Value = StringMayBeEnteredIn(row, "Alternate Name")
                    .Item(Me.colCategoryNo.Name, pos).Value = StringMayBeEnteredIn(row, "Category No")
                    .Item(Me.colUnitMeasure.Name, pos).Value = StringMayBeEnteredIn(row, "Unit Measure")
                    .Item(Me.colGroups.Name, pos).Value = StringMayBeEnteredIn(row, "Groups")
            ...
            '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            Me.lblRecordsImported.Text = importedData.Rows.Count.ToString() + " record(s) were imported for Drugs!"
            '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
    ...
    Private Sub fbnSaveAll_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles fbnSaveAll.Click
        ...
        Try
            ...
            '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            If Me.dgvImportedData.RowCount < 1 Then Throw New ArgumentException("Must have at least one entry for Drugs!")
            '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            ...
            For rowNo As Integer = 0 To Me.dgvImportedData.RowCount - 1
                ...
                Try
                    ...
                    ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
                    Dim drugNo As String = StringEnteredIn(cells, Me.colDrugNo)
                    Dim drugName As String = StringEnteredIn(cells, Me.colDrugName, "Drug Name!")
                    Dim categoryNo As String = StringEnteredIn(cells, Me.colCategoryNo, "Category No!")
                    Dim unitMeasure As String = StringEnteredIn(cells, Me.colUnitMeasure, "Unit Measure!")
                    Dim groups As String = StringEnteredIn(cells, Me.colGroups, "Groups")
                    ...
                    Using oDrugs As New SyncSoft.SQLDb.Drugs()
                        ...
                        With oDrugs
                            ...
                            .CategoryNo = StringEnteredIn(cells, Me.colCategoryNo)
                            If String.IsNullOrEmpty(GetLookupDataID(LookupObjects.Groups, groups)) Then
                                Throw New ArgumentException("Groups has wrong value!")
                            Else : .GroupsID = GetLookupDataID(LookupObjects.Groups, groups)
                            End If
    ...
    Private Sub fbnErrorLog_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles fbnErrorLog.Click
        ...
        Try
            ...
            Dim importLogFile As String = My.Computer.FileSystem.SpecialDirectories.Temp + "\Drugs Import Log.txt"
