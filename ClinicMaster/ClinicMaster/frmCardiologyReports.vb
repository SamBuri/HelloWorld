...
Public Class frmCardiologyReports
...
#Region " Fields "
    ...
    Private totalCardiologyRequests As Integer = 0
...
#Region " Validations "
    ...
    Private Sub dtpExamDateTime_Validating(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles dtpExamDateTime.Validating
        ...
        Dim errorMSG As String = "Cardiology exam date can't be before visit date!"
...
#End Region
    ...
    Private Sub btnLoadProcessingCardiology_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnLoadProcessingCardiology.Click
        ...
        Try
            ...
            ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            Dim fPendingItems As New frmPendingItems(Me.stbVisitNo, AlertItemCategory.CardiologyProcessing)
            fPendingItems.ShowDialog(Me)

            ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            Dim visitNo As String = RevertText(StringMayBeEnteredIn(Me.stbVisitNo))
            Me.LoadCardiologyData(visitNo)
            '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
    ...
    Private Sub LoadCardiologyRequests(ByVal visitNo As String)
        ...
        Try
            ...
            If Me.ebnSaveUpdate.ButtonText = ButtonCaption.Save Then
                ...
                items = oItems.GetItems(visitNo, oItemCategoryID.Cardiology, oItemStatusID.Processing).Tables("Items")

                If items Is Nothing OrElse items.Rows.Count < 1 Then
                    Dim message As String = "This visit has no processing Cardiology examination!"
                    DisplayMessage(message)
                    CardiologyRequestsCount = 0
                    Return
                Else : CardiologyRequestsCount = items.Rows.Count
                End If

            ElseIf Me.ebnSaveUpdate.ButtonText = ButtonCaption.Update Then
                items = oItems.GetItems(visitNo, oItemCategoryID.Cardiology, oItemStatusID.Done).Tables("Items")
            End If
    ...
    Private Sub btnFindByFingerprint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnFindByFingerprint.Click
        ...
        Try
            ...
            ElseIf oVariousOptions.FingerprintDevice.ToUpper().Equals(oFingerprintDeviceID.DigitalPersona.ToUpper()) Then
                ...
                If Not String.IsNullOrEmpty(Me.oDigitalPersonaTemplate.ID) Then Me.LoadCardiologyData(Me.oDigitalPersonaTemplate.ID)
...
#End Region
    ...
    Private Sub LoadCardiologyData(ByVal visitNo As String)
    ...
    Private Sub ShowPatientDetails(ByVal visitNo As String)
        ...
        Try
            ...
            totalCardiologyRequests = IntegerMayBeEnteredIn(row, "TotalCardiologyRequests")
    ...
    Private Sub GetCardiologyDetails()
        ...
        Try
            ...
            '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            Dim items As DataTable = oItems.GetItem(visitNo, examCode, oItemCategoryID.Cardiology).Tables("Items")
    ...
    Private Sub fbnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles fbnDelete.Click
        ...
        '    DisplayMessage(oCardiologyReports.Delete())
        '    '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
    ...
    Private Sub fbnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles fbnSearch.Click
        ...
        Try
            ...
            Dim dataSource As DataTable = oCardiologyReports.GetCardiologyReports(visitNo, examCode, oItemCategoryID.Cardiology).Tables("CardiologyReports")
    ...
    Private Sub ebnSaveUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ebnSaveUpdate.Click
        ...
        Try
            ...
            Dim oCardiologyReports As New SyncSoft.SQLDb.CardiologyReports()
            Dim lCardiologyReports As New List(Of DBConnect)
            ...
            ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            lCardiologyReports.Add(oCardiologyReports)
            ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            ...
            ''''make queue
            lWaitingPatient = GetQueuesList(visitNo, oServicePoint.Cardiology(), Me.priorityID, lservicePoints)
            ...
            Select Case Me.ebnSaveUpdate.ButtonText
                ...
                Case ButtonCaption.Save
                    ...
                    If billMode.ToUpper().Equals(insuranceBillMode.ToUpper()) Then
                        ...
                        Dim limitAmount As Decimal = GetPolicyLimit(billNo, oBenefitCodes.Cardiology)
                        Dim consumedAmount As Decimal = GetPolicyConsumedAmount(billNo, oBenefitCodes.Cardiology)
                        ...
                        Using oClaimDetails As New SyncSoft.SQLDb.ClaimDetails()
                            ...
                            With oClaimDetails
                                ...
                                .ClaimNo = claimNo
                                .ItemName = examName
                                .BenefitCode = oBenefitCodes.Cardiology
                                .Quantity = quantity
                                .UnitPrice = unitPrice
                                .Adjustment = 0
                                .Amount = amount
                                .Notes = "Cardiology examination, done to Patient No: " + patientNo
                    ...
                    '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
                    transactions.Add(New TransactionList(Of DBConnect)(lCardiologyReports, Action.Save))
                    ...
                    If GetShortDate(DateMayBeEnteredIn(Me.dtpExamDateTime)) >= GetShortDate(Today.AddHours(-12)) AndAlso
                        ...
                        Using oAlerts As New SyncSoft.SQLDb.Alerts()
                            With oAlerts
                                ...
                                .Notes = (totalCardiologyRequests - CardiologyRequestsCount).ToString() + " of " + totalCardiologyRequests.ToString() + " Done"
                                .LoginID = CurrentUser.LoginID
                    ...
                    If oVariousOptions.SMSNotificationAtCardiology Then
                        If stbPhoneNo.Text IsNot Nothing AndAlso Not String.IsNullOrEmpty(stbPhoneNo.Text) Then
                            ...
                            Dim txtmessage As String = ("Hi" + " " + oPatients.FirstName.ToString + " " + " Your Cardiology Report is done check with DR." + " " + stbPrimaryDoctor.Text + " " + "at" + " " + (productOwner) + " " +
                            "- Via ClinicMaster")
                            SaveTextMessage(txtmessage, recipients, Now, oVariousOptions.SMSLifeSpanCardiology)
                ...
                Case ButtonCaption.Update
                    ...
                    transactions.Add(New TransactionList(Of DBConnect)(lCardiologyReports, Action.Update, "CardiologyReports"))
                    records = DoTransactions(transactions)
...
#Region " Edit Methods "
    ...
    Public Sub Edit()
        ...
        Me.btnLoadProcessingCardiology.Enabled = False
    ...
    Public Sub Save()
        ...
        Me.btnLoadProcessingCardiology.Enabled = True
