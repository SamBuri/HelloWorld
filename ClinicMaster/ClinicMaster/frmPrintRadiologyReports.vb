...
Public Class frmPrintRadiologyReports
...
#End Region
    ...
    Private Sub frmRadiologyReports_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            If Not String.IsNullOrEmpty(defaultVisitNo) Then
                ...
                If Not String.IsNullOrEmpty(defaultVisitNo) Then Me.LoadRadiology(defaultVisitNo)
    ...
    Private Sub btnLoadDoneRadiology_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnLoadDoneRadiology.Click
        ...
        Try
            ...
            '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            Dim fDoneItems As New frmDoneItems(Me.stbVisitNo, AlertItemCategory.Radiology)
    ...
    Private Sub LoadRadiologyRequests(ByVal visitNo As String)
        ...
        Try
            ...
            ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            Dim items As DataTable = oItems.GetItems(visitNo, oItemCategoryID.Radiology, oItemStatusID.Done).Tables("Items")

            ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            If items Is Nothing OrElse items.Rows.Count < 1 Then Throw New ArgumentException("This visit has no done radiology examination!")
    ...
    Private Sub GetRadiologyDetails()
        ...
        Try
            ...
            Dim radiologyReports As DataTable = oRadiologyReports.GetRadiologyReports(visitNo, examCode, oItemCategoryID.Radiology).Tables("RadiologyReports")

            If radiologyReports Is Nothing OrElse radiologyReports.Rows.Count < 1 Then Return
            Dim row As DataRow = radiologyReports.Rows(0)
...
#Region " Radiology Printing "
    ...
    Private Sub btnPrintPreview_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrintPreview.Click
        ...
        Try
            ...
            Dim printdesc As String = (stbFullName.Text + " 's" + " Radiology Report (Preview)")
            SavePrintDetails(patientNo, docNo, printdesc, docTypeID.Radiology)
    ...
    Private Sub PrintRadiology()
        ...
        Dim patientNo As String = RevertText(StringEnteredIn(Me.stbPatientNo))
        Dim docNo As String = RevertText(StringEnteredIn(Me.stbVisitNo))
        Dim printdesc As String = (stbFullName.Text + " 's" + " Radiology Report")
        Try
    ...
    Private Sub SetRadiologyPrintData()
        ...
        Try
            ...
            Dim radiologist As String = StringMayBeEnteredIn(Me.stbRadiologist)
