...
#End Region
    ...
    Private Sub frmNotPaidGRNs_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub dgvPeriodicPurchaseOrders_CellDoubleClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvPeriodicPurchaseOrders.CellDoubleClick
        ...
        Try
            ...
            Dim purchaseOrderNo As String = Me.dgvPeriodicPurchaseOrders.Item(Me.ColGRNNo.Name, e.RowIndex).Value.ToString()
