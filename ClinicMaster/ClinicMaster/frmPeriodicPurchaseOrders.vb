...
Public Class frmPeriodicPurchaseOrders
...
#End Region
    ...
    Private Sub frmPeriodicPurchaseOrders_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

        Try
            Me.Cursor = Cursors.WaitCursor()

            Me.Text = "Periodic Purchase Orders"

            Me.dtpStartDate.MaxDate = Today
            Me.dtpEndDate.MaxDate = Today

            Me.ShowPeriodicPurchaseOrders(Today, Today)
    ...
    Private Sub ShowPeriodicPurchaseOrders(ByVal startDate As Date, ByVal endDate As Date)
        ...
        Try
            ...
            Dim purchaseOrders As DataTable = oPurchaseOrders.GetPeriodicPurchaseOrders(startDate, endDate, Me._IncludeReceived).Tables("PurchaseOrders")
    ...
    Private Sub dgvPeriodicPurchaseOrders_CellDoubleClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvPeriodicPurchaseOrders.CellDoubleClick

        Try

            Dim purchaseOrderNo As String = Me.dgvPeriodicPurchaseOrders.Item(Me.colPurchaseOrderNo.Name, e.RowIndex).Value.ToString()

            If TypeOf Me.alertNoControl Is TextBox Then
                CType(Me.alertNoControl, TextBox).Text = purchaseOrderNo
                CType(Me.alertNoControl, TextBox).Focus()

            ElseIf TypeOf Me.alertNoControl Is SmartTextBox Then
                CType(Me.alertNoControl, SmartTextBox).Text = purchaseOrderNo
                CType(Me.alertNoControl, SmartTextBox).Focus()

            ElseIf TypeOf Me.alertNoControl Is ComboBox Then
                CType(Me.alertNoControl, ComboBox).Text = purchaseOrderNo
    ...
    Private Sub cmsAlertList_Opening(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles cmsAlertList.Opening
        ...
        If Me.dgvPeriodicPurchaseOrders.ColumnCount < 1 OrElse Me.dgvPeriodicPurchaseOrders.RowCount < 1 Then
    ...
    Private Sub cmsAlertListCopy_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmsAlertListCopy.Click
        ...
        Try
            ...
            If Me.dgvPeriodicPurchaseOrders.SelectedCells.Count < 1 Then Return
            Clipboard.SetText(CopyFromControl(Me.dgvPeriodicPurchaseOrders))
    ...
    Private Sub cmsAlertListSelectAll_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmsAlertListSelectAll.Click
        Try
            ...
            Me.Cursor = Cursors.WaitCursor
            Me.dgvPeriodicPurchaseOrders.SelectAll()
