...
Public Class frmImportInsuranceExclusions

#Region " Fields "
    Private _ErrorLog As New StringBuilder(String.Empty)
#End Region

    Private Sub frmImportInsuranceExclusions_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub fbnImport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles fbnImport.Click
        ...
        Try
            ...
            Dim range As String = ""
            Dim where As String = "where [Insurance No] is not null and [Item Code] is not null and [Item Category] is not null"
            ...
            For pos As Integer = 0 To importedData.Rows.Count - 1
                ...
                With Me.dgvImportedData
                    ...
                    .Item(Me.colInsuranceName.Name, pos).Value = StringMayBeEnteredIn(row, "Insurance Name")
            ...
            '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            Me.lblRecordsImported.Text = importedData.Rows.Count.ToString() + " record(s) were imported for Insurance Exclusions!"
            '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
    ...
    Private Sub fbnSaveAll_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles fbnSaveAll.Click
        ...
        Try
            ...
            '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            If Me.dgvImportedData.RowCount < 1 Then Throw New ArgumentException("Must have at least one entry for Insurance Exclusions!")
            '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
                ...
                Try
                    ...
                    Using oInsuranceExclusions As New SyncSoft.SQLDb.InsuranceExclusions()
                        ...
                        With oInsuranceExclusions
                            ...
                            .InsuranceNo = RevertText(StringEnteredIn(cells, Me.colInsuranceNo))
    ...
    Private Sub fbnErrorLog_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles fbnErrorLog.Click
        ...
        Try
            ...
            Dim importLogFile As String = My.Computer.FileSystem.SpecialDirectories.Temp + "\InsuranceExclusions Import Log.txt"
