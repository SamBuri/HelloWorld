...
Public Class frmDoneLabResults

#Region " Fields "
    Private alertNoControl As Control
#End Region

    Private Sub frmDoneLabResults_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

        Try
            Me.Cursor = Cursors.WaitCursor()

            Me.Text = "Done Laboratory Results"
    ...
    Private Sub ShowDoneLabResults(ByVal startDate As Date, ByVal endDate As Date)
        ...
        Try
            ...
            labResults = oLabResults.GetDoneLabResults(startDate, endDate).Tables("LabResults")

            '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            LoadGridData(Me.dgvDoneLabResults, labResults)
    ...
    Private Sub dgvDoneLabResults_CellDoubleClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvDoneLabResults.CellDoubleClick

        Try

            Dim specimenNo As String = Me.dgvDoneLabResults.Item(Me.colSpecimenNo.Name, e.RowIndex).Value.ToString()
    ...
    Private Sub cmsAlertList_Opening(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles cmsAlertList.Opening
        ...
        If Me.dgvDoneLabResults.ColumnCount < 1 OrElse Me.dgvDoneLabResults.RowCount < 1 Then
    ...
    Private Sub cmsAlertListCopy_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmsAlertListCopy.Click
        Try
            ...
            If Me.dgvDoneLabResults.SelectedCells.Count < 1 Then Return
            Clipboard.SetText(CopyFromControl(Me.dgvDoneLabResults))
    ...
    Private Sub cmsAlertListSelectAll_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmsAlertListSelectAll.Click
        Try
            ...
            Me.Cursor = Cursors.WaitCursor
            Me.dgvDoneLabResults.SelectAll()
