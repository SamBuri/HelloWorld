...
Public Class frmCardiologyRequests
...
#End Region
    ...
    Private Sub frmCardiologyRequests_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub frmCardiologyRequests_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        '''''''''''''''''''''''''''''''''''''''''''''''''''''''''
        Me.ShowSentAlerts()
        '''''''''''''''''''''''''''''''''''''''''''''''''''''''''
    End Sub

    Private Sub frmCardiologyRequests_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub btnLoadToCardiologyVisits_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnLoadToCardiologyVisits.Click
        ...
        Try
            ...
            '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            Dim fPendingItems As New frmPendingItems(Me.stbVisitNo, AlertItemCategory.Cardiology)
    ...
    Private Sub LoadCardiologyRequests(ByVal visitNo As String)
        ...
        Dim CardiologyRequests As DataTable
        ...
        Try
            ...
            If billMode.ToUpper().Equals(cashAccountNo.ToUpper()) AndAlso Not oVariousOptions.AllowAccessCashServices AndAlso Not accessCashServices AndAlso Not haspackage Then
                CardiologyRequests = oItems.GetItems(visitNo, oItemCategoryID.Cardiology, oItemStatusID.Pending, oPayStatusID.PaidFor).Tables("Items")
            ...
            ElseIf billMode.ToUpper().Equals(cashAccountNo.ToUpper()) AndAlso haspackage.Equals(True) AndAlso oPayStatusID.Equals(oPayStatusID.NA) Then
                CardiologyRequests = oItems.GetItems(visitNo, oItemCategoryID.Cardiology, oItemStatusID.Pending).Tables("Items")
            ...
            Else : CardiologyRequests = oItems.GetItems(visitNo, oItemCategoryID.Cardiology, oItemStatusID.Pending).Tables("Items")
            End If
...
#Region " Alerts "
    ...
    Private Function ShowSentAlerts() As Integer
        ...
        Try
            ...
            ' Load from Staff
            alerts = oAlerts.GetAlerts(oAlertTypeID.Cardiology).Tables("Alerts")

            Dim alertsNo As Integer = alerts.Rows.Count

            ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            Me.lblAlerts.Text = "Doctor Cardiology Requests: " + alertsNo.ToString()
    ...
    Private Sub btnViewList_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnViewList.Click
        ...
        '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
        Dim oAlertTypeID As New LookupDataID.AlertTypeID()
        Dim fAlerts As New frmAlerts(oAlertTypeID.Cardiology, Me.stbVisitNo)
...
#End Region
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Try
            ...
            ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            If Me.dgvCardiology.RowCount < 1 Then
                Throw New ArgumentException("Must register at least one entry for Cardiology examination " + ControlChars.NewLine +
       ...
       If billMode.ToUpper().Equals(insuranceBillMode.ToUpper()) Then IsInsuranceFingerprintVerified(patientNo)
            ...
            Dim billFee As Decimal = DecimalEnteredIn(Me.stbBillForCardiology, True, "Bill for Cardiology!")
            ...
            If Not oVariousOptions.AllowAccessCashServices AndAlso Not accessCashServices AndAlso billMode.ToUpper().Equals(cashAccountNo.ToUpper()) Then
                ...
                For Each row As DataGridViewRow In Me.dgvCardiology.Rows
                    ...
                    cashNotPaid = False
                Next
                message = "The system does not allow accepting of not paid for Cardiology Requests!"
            ...
            If Not oVariousOptions.AllowAccessCoPayServices AndAlso Not coPayType.ToUpper().Equals(_NACoPayType.ToUpper()) AndAlso
             Not billMode.ToUpper().Equals(cashAccountNo.ToUpper()) Then
                ...
                message = "The system does not allow accepting of Cardiology Request(s) whose co-pay percent or value is not paid for a co-pay visit!"
                If cashNotPaid Then Throw New ArgumentException(message)
            ...
            For rowNo As Integer = 0 To Me.dgvCardiology.RowCount - 1
                ...
                Dim examName As String = StringEnteredIn(cells, Me.colCardiologyExamination, "exam name!")
                ...
                Dim cashAmount As Decimal = DecimalEnteredIn(cells, Me.colAmount, False, "CashAmount!")
                ...
                End If
            Next
            oSmartCardMembers.CopayType = Me.copayTypeID
