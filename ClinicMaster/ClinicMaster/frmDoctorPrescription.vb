...
Public Class frmDoctorPrescription
...
#End Region
    ...
    Private Sub frmDoctorPrescription_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            If Not String.IsNullOrEmpty(defaultVisitNo) Then
                ...
                Me.LoadPrescriptions(defaultVisitNo)
            End If
            '''''''''''''''''''''''''''''''''''''''''''''''''''
    ...
    Private Sub frmDoctorPrescription_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub frmDoctorPrescription_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
                ...
                Try
                    Using oItems As New SyncSoft.SQLDb.Items()
                        ...
                        If CBool(Me.dgvPrescription.Item(Me.colPrescriptionSaved.Name, rowNo).Value).Equals(False) Then
                            ...
                            ElseIf availableStock < oItems.Quantity Then
                            ...
                            If expiryDate > AppData.NullDateValue AndAlso expiryDate < Today Then
                                If Not oVariousOptions.AllowPrescriptionExpiredDrugs() Then
                                    message = "Expiry date for " + drugName + " had reached. " + _
