...
Public Class frmCardiologyExaminations
...
#End Region
    ...
    Private Sub frmCardiologyExaminations_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

        Try
            Me.Cursor = Cursors.WaitCursor

            ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            LoadLookupDataCombo(Me.fcbCardiologyCategoriesID, LookupObjects.CardiologyCategories, False)
            LoadLookupDataCombo(Me.fcbCardiologySiteID, LookupObjects.CardiologySites, False)
            ...
            Me.LoadInsurances()
            Me.SetNextCardiologyExamID()

            If (ebnSaveUpdate.ButtonText = ButtonCaption.Update) Then
                LoadCardiologyExaminantions()
    ...
    Private Sub frmCardiologyExaminations_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles fbnDelete.Click
        ...
        Try
            ...
            oCardiologyExaminations.ExamCode = SubstringRight(RevertText(StringEnteredIn(Me.cboExamCode, "Exam Code")))
            DisplayMessage(oCardiologyExaminations.Delete())
            '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
    ...
    Private Sub btnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        Try
            ...
            Dim dataSource As DataTable = oCardiologyExaminations.GetCardiologyExaminations(examCode).Tables("CardiologyExaminations")
    ...
    Private Sub ebnSaveUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ebnSaveUpdate.Click
        ...
        Dim itemCategoryID As String = oItemCategoryID.Cardiology
        Try

            Me.Cursor = Cursors.WaitCursor

            Dim oCardiologyExaminations As New SyncSoft.SQLDb.CardiologyExaminations()
            Dim lCardiologyExaminations As New List(Of DBConnect)

            With oCardiologyExaminations

                .ExamCode = itemCode
                .ExamName = StringEnteredIn(Me.stbExamName, "Exam Name!")
                .CardiologyCategoriesID = StringValueEnteredIn(Me.fcbCardiologyCategoriesID, "Cardiology Category!")
                .CardiologySiteID = StringValueEnteredIn(Me.fcbCardiologySiteID, "Cardiology Site!")
            ...
            '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            lCardiologyExaminations.Add(oCardiologyExaminations)
            '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''

            If oCardiologyExaminations.Hidden.Equals(True) Then
            ...
            '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            OpenBillableMappings(ebnSaveUpdate.ButtonText, oItemCategoryID.Cardiology, itemCode)
            ...
            Select Case Me.ebnSaveUpdate.ButtonText
                ...
                Case ButtonCaption.Save
                    ...
                    '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
                    transactions.Add(New TransactionList(Of DBConnect)(lCardiologyExaminations, Action.Save))
                ...
                Case ButtonCaption.Update
                    ...
                    transactions.Add(New TransactionList(Of DBConnect)(lCardiologyExaminations, Action.Update, "CardiologyExaminations"))
                    transactions.Add(New TransactionList(Of DBConnect)(BillCustomFeeList, Action.Save))
                    transactions.Add(New TransactionList(Of DBConnect)(InsuranceCustomFeeList, Action.Save))
...
#Region " BillCustomFee - Grid "
    ...
    Private Sub LoadBillCustomFee(ByVal itemCode As String)
        ...
        Try
            ...
            Dim billCustomFee As DataTable = oBillCustomFee.GetBillCustomFee(itemCode, oItemCategoryID.Cardiology).Tables("BillCustomFee")
...
#Region " InsuranceCustomFee - Grid "
    ...
    Private Sub LoadInsuranceCustomFee(ByVal itemCode As String)
        ...
        Try
            ...
            Dim insuranceCustomFee As DataTable = oInsuranceCustomFee.GetInsuranceCustomFee(itemCode, oItemCategoryID.Cardiology).Tables("InsuranceCustomFee")
...
#Region " Edit Methods "
    ...
    Public Sub Save()
        ...
        ResetControlsIn(Me.tpgInsuranceCustomFee)
        Me.SetNextCardiologyExamID()
        Me.cboExamCode.Enabled = Not InitOptions.CardiologyExamCodeLocked
    End Sub
...
#Region "27/06/2016"
    ...
    Private Sub LoadCardiologyExaminantions()
        ...
        Try
            ...
            Dim CardiologyExamination As DataTable = oCardiologyExamination.GetCardiologyExaminations.Tables("CardiologyExaminations")

            '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            LoadComboData(Me.cboExamCode, CardiologyExamination, "ExamFullName")
...
#Region " SET AUTONUMBERS"
    ...
    Private Sub SetNextCardiologyExamID()
        ...
        Try
            ...
            Dim autoNumbers As DataTable = oAutoNumbers.GetAutoNumbers("CardiologyExaminations", "ExamCode").Tables("AutoNumbers")
            Dim row As DataRow = autoNumbers.Rows(0)

            Dim paddingLEN As Integer = IntegerEnteredIn(row, "PaddingLEN")
            Dim paddingCHAR As Char = CChar(StringEnteredIn(row, "PaddingCHAR"))

            Dim cardiologyExamCodePrefix As String = oVariousOption.CardiologyExamCodePrefix
            Dim nextExamCode As String = CStr(oCardiologyExaminations.GetNextCardiologyExamID).PadLeft(paddingLEN, paddingCHAR)
            Me.cboExamCode.Text = FormatText((cardiologyExamCodePrefix + nextExamCode).Trim(), "CardiologyExaminations", "ExamCode")
