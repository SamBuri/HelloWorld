...
Public Class frmNotPaidServiceInvoices
...
#End Region
    ...
    Private Sub frmNotPaidServiceInvoices_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub dgvPeriodicServiceInvoices_CellDoubleClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvPeriodicServiceInvoices.CellDoubleClick
        ...
        Try
            ...
            Dim purchaseOrderNo As String = Me.dgvPeriodicServiceInvoices.Item(Me.ColInvoiceNo.Name, e.RowIndex).Value.ToString()
