...
Public Class frmMaternityServices
...
#End Region
    ...
    Private Sub frmMaternityServices_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub stbMaternityCode_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Me.CallOnKeyEdit()
    End Sub
    ...
    Private Sub fbnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles fbnDelete.Click
        ...
        Try
            ...
            oMaternityServices.MaternityCode = SubstringRight(RevertText(StringEnteredIn(Me.cboMaternityCode, "Maternity Code!")))

            DisplayMessage(oMaternityServices.Delete())
            ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
    ...
    Private Sub fbnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles fbnSearch.Click
        ...
        Try
            ...
            Dim maternityCode As String = SubstringRight(RevertText(StringEnteredIn(Me.cboMaternityCode, "Maternity Code!")))
            Dim dataSource As DataTable = oMaternityServices.GetMaternityServices(maternityCode).Tables("MaternityServices")
            Me.DisplayData(dataSource)

            Me.LoadBillCustomFee(maternityCode)
            Me.LoadInsuranceCustomFee(maternityCode)
    ...
    Private Sub ebnSaveUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ebnSaveUpdate.Click
        ...
        Dim itemCode As String = SubstringRight(RevertText(StringEnteredIn(Me.cboMaternityCode, "Maternity Code!"))).ToUpper()
        Dim itemCategoryID As String = oItemCategoryID.Maternity
        Try
            Me.Cursor = Cursors.WaitCursor()

            Dim oMaternityServices As New SyncSoft.SQLDb.MaternityServices()
            Dim lMaternityServices As New List(Of DBConnect)

            With oMaternityServices

                .MaternityCode = itemCode
                .MaternityName = StringEnteredIn(Me.stbMaternityName, "Maternity Name!")
            ...
            '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            lMaternityServices.Add(oMaternityServices)

            '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            If oMaternityServices.Hidden.Equals(True) Then
                Dim message As String = "You have chosen to hide this Maternity Service and won’t be presented for selection. " +
            ...
            OpenBillableMappings(ebnSaveUpdate.ButtonText, oItemCategoryID.Maternity, itemCode)
            '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            ...
            Select Case Me.ebnSaveUpdate.ButtonText
                ...
                Case ButtonCaption.Save
                    ...
                    '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
                    transactions.Add(New TransactionList(Of DBConnect)(lMaternityServices, Action.Save))
                ...
                Case ButtonCaption.Update
                    ...
                    transactions.Add(New TransactionList(Of DBConnect)(lMaternityServices, Action.Update, "MaternityServices"))
                    transactions.Add(New TransactionList(Of DBConnect)(BillCustomFeeList, Action.Save))
                    transactions.Add(New TransactionList(Of DBConnect)(InsuranceCustomFeeList, Action.Save))
    ...
    Private Function BillCustomFeeList() As List(Of DBConnect)
        ...
        Try
            ...
            Dim itemCode As String = RevertText(StringEnteredIn(Me.cboMaternityCode, "Maternity Code!"))
...
#Region " BillCustomFee - Grid "
    ...
    Private Sub LoadBillCustomFee(ByVal itemCode As String)
        ...
        Try
            ...
            Dim billCustomFee As DataTable = oBillCustomFee.GetBillCustomFee(itemCode, oItemCategoryID.Maternity).Tables("BillCustomFee")
...
#Region " InsuranceCustomFee - Grid "
    ...
    Private Sub LoadInsuranceCustomFee(ByVal itemCode As String)
        ...
        Try
            ...
            Dim insuranceCustomFee As DataTable = oInsuranceCustomFee.GetInsuranceCustomFee(itemCode, oItemCategoryID.Maternity).Tables("InsuranceCustomFee")
...
#Region " Edit Methods "
    ...
    Public Sub Save()
        ...
        ResetControlsIn(Me.tpgInsuranceCustomFee)
        Me.SetNextMaternityID()
        Me.cboMaternityCode.Enabled = Not InitOptions.MaternityCodeLocked
    End Sub
    ...
    Private Sub cboMaternityCode_Leave(sender As Object, e As EventArgs) Handles cboMaternityCode.Leave
        If ebnSaveUpdate.ButtonText = ButtonCaption.Update Then
            stbMaternityName.Text = SubstringLeft(RevertText(StringMayBeEnteredIn(cboMaternityCode)))
            cboMaternityCode.Text = SubstringRight(RevertText(StringMayBeEnteredIn(cboMaternityCode)))
    ...
    Private Sub LoadMaternityServices()
        ...
        Try
            ...
            Dim maternityServices As DataTable = oMaternityServices.GetMaternityServices().Tables("MaternityServices")

            '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            LoadComboData(Me.cboMaternityCode, maternityServices, "MaternityServiceFullName")
            '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
...
#Region " SET AUTONUMBERS"
    ...
    Private Sub SetNextMaternityID()
        ...
        Try
            ...
            Dim autoNumbers As DataTable = oAutoNumbers.GetAutoNumbers("MaternityServices", "MaternityCode").Tables("AutoNumbers")
            Dim row As DataRow = autoNumbers.Rows(0)

            Dim paddingLEN As Integer = IntegerEnteredIn(row, "PaddingLEN")
            Dim paddingCHAR As Char = CChar(StringEnteredIn(row, "PaddingCHAR"))

            Dim MaternityCodePrefix As String = oVariousOption.MaternityCodePrefix
            Dim nextMaternityCode As String = CStr(oMaternityServices.GetNextMaternityID).PadLeft(paddingLEN, paddingCHAR)
            Me.cboMaternityCode.Text = FormatText((MaternityCodePrefix + nextMaternityCode).Trim(), "MaternityServices", "MaternityCode")
