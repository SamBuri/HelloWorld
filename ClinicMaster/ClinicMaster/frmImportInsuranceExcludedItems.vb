...
Public Class frmImportInsuranceExcludedItems

#Region " Fields "
    Private _ErrorLog As New StringBuilder(String.Empty)
#End Region

    Private Sub frmImportInsuranceExcludedItems_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub fbnImport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles fbnImport.Click
        ...
        Try
            ...
            Dim range As String = ""
            Dim where As String = "where [Company No] is not null and [Policy No] is not null and [Item Code] is not null and [Item Category] is not null"
            ...
            For pos As Integer = 0 To importedData.Rows.Count - 1
                ...
                With Me.dgvImportedData
                    ...
                    .Item(Me.colCompanyName.Name, pos).Value = StringMayBeEnteredIn(row, "Company Name")
                    .Item(Me.colPolicyNo.Name, pos).Value = StringMayBeEnteredIn(row, "Policy No")
                    .Item(Me.colPolicyName.Name, pos).Value = StringMayBeEnteredIn(row, "Policy Name")
            ...
            '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            Me.lblRecordsImported.Text = importedData.Rows.Count.ToString() + " record(s) were imported for Insurance Excluded Items!"
            '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
    ...
    Private Sub fbnSaveAll_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles fbnSaveAll.Click
        ...
        Try
            ...
            '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            If Me.dgvImportedData.RowCount < 1 Then Throw New ArgumentException("Must have at least one entry for Insurance Excluded Items!")
            '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
    ...
    Private Sub fbnErrorLog_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles fbnErrorLog.Click
        ...
        Try
            ...
            Dim importLogFile As String = My.Computer.FileSystem.SpecialDirectories.Temp + "\InsuranceExcludedItems Import Log.txt"
