...
Public Class frmDentalServices
...
#End Region
    ...
    Private Sub frmDentalServices_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

        Try
            Me.Cursor = Cursors.WaitCursor()

            ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            LoadLookupDataCombo(Me.cboDentalCategoryID, LookupObjects.DentalCategory, False)
    ...
    Private Sub stbDentalCode_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Me.CallOnKeyEdit()
    End Sub
    ...
    Private Sub fbnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles fbnDelete.Click
        ...
        Try
            ...
            oDentalServices.DentalCode = SubstringRight(RevertText(StringEnteredIn(Me.cboDentalCode, "Dental Code!")))

            DisplayMessage(oDentalServices.Delete())
            '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
    ...
    Private Sub fbnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles fbnSearch.Click
        ...
        Try
            ...
            Dim dentalCode As String = SubstringRight(RevertText(StringEnteredIn(Me.cboDentalCode, "Dental Code!")))
            Dim dataSource As DataTable = oDentalServices.GetDentalServices(dentalCode).Tables("DentalServices")
            Me.DisplayData(dataSource)

            Me.LoadBillCustomFee(dentalCode)
            Me.LoadInsuranceCustomFee(dentalCode)
    ...
    Private Sub ebnSaveUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ebnSaveUpdate.Click
        ...
        Dim itemCode As String = SubstringRight(RevertText(StringEnteredIn(Me.cboDentalCode, "Dental Code!"))).ToUpper()
        Dim itemCategoryID As String = oItemCategoryID.Dental
        Try
            Me.Cursor = Cursors.WaitCursor()

            Dim oDentalServices As New SyncSoft.SQLDb.DentalServices()
            Dim lDentalServices As New List(Of DBConnect)

            With oDentalServices

                .DentalCode = itemCode
                .DentalName = StringEnteredIn(Me.stbDentalName, "Dental Name!")
                .DentalCategoryID = StringValueEnteredIn(Me.cboDentalCategoryID, "Dental Category!")
            ...
            '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            lDentalServices.Add(oDentalServices)

            '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            If oDentalServices.Hidden.Equals(True) Then
                Dim message As String = "You have chosen to hide this Dental Service and won’t be presented for selection. " +
            ...
            '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            OpenBillableMappings(ebnSaveUpdate.ButtonText, oItemCategoryID.Dental, itemCode)
            Select Case Me.ebnSaveUpdate.ButtonText

                Case ButtonCaption.Save
                   
                    '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
                    transactions.Add(New TransactionList(Of DBConnect)(lDentalServices, Action.Save))
                ...
                Case ButtonCaption.Update
                    ...
                    transactions.Add(New TransactionList(Of DBConnect)(lDentalServices, Action.Update, "DentalServices"))
                    transactions.Add(New TransactionList(Of DBConnect)(BillCustomFeeList, Action.Save))
                    transactions.Add(New TransactionList(Of DBConnect)(InsuranceCustomFeeList, Action.Save))
    ...
    Private Function BillCustomFeeList() As List(Of DBConnect)
        ...
        Try
            ...
            Dim itemCode As String = SubstringRight(RevertText(StringEnteredIn(Me.cboDentalCode, "Dental Code!")))
...
#Region " BillCustomFee - Grid "
    ...
    Private Sub LoadBillCustomFee(ByVal itemCode As String)
        ...
        Try
            ...
            Dim billCustomFee As DataTable = oBillCustomFee.GetBillCustomFee(itemCode, oItemCategoryID.Dental).Tables("BillCustomFee")
...
#Region " InsuranceCustomFee - Grid "
    ...
    Private Sub LoadInsuranceCustomFee(ByVal itemCode As String)
        ...
        Try
            ...
            Dim insuranceCustomFee As DataTable = oInsuranceCustomFee.GetInsuranceCustomFee(itemCode, oItemCategoryID.Dental).Tables("InsuranceCustomFee")
...
#Region " Edit Methods "
    ...
    Public Sub Save()
        ...
        Me.SetNextDentalID()
        Me.cboDentalCode.Enabled = Not InitOptions.DentalCodeLocked
    End Sub
    ...
    Private Sub LoadDentalServices()
        ...
        Try
            ...
            Dim dentalServices As DataTable = oDentalService.GetDentalServices().Tables("DentalServices")

            '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            LoadComboData(Me.cboDentalCode, dentalServices, "DentalFullName")
            '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
    ...
    Private Sub cboDentalCode_Leave(sender As Object, e As EventArgs) Handles cboDentalCode.Leave
        If ebnSaveUpdate.ButtonText = ButtonCaption.Update Then
            Me.stbDentalName.Text = SubstringLeft(RevertText(StringMayBeEnteredIn(cboDentalCode)))
            Me.cboDentalCode.Text = SubstringRight(RevertText(StringMayBeEnteredIn(cboDentalCode)))
        End If
    End Sub
...
#Region " SET AUTONUMBERS"
    ...
    Private Sub SetNextDentalID()
        ...
        Try
            ...
            Dim autoNumbers As DataTable = oAutoNumbers.GetAutoNumbers("DentalServices", "DentalCode").Tables("AutoNumbers")
            Dim row As DataRow = autoNumbers.Rows(0)

            Dim paddingLEN As Integer = IntegerEnteredIn(row, "PaddingLEN")
            Dim paddingCHAR As Char = CChar(StringEnteredIn(row, "PaddingCHAR"))

            Dim dentalCodePrefix As String = oVariousOption.DentalCodePrefix
            Dim nextDentalCode As String = CStr(oDentalServices.GetNextDentalID).PadLeft(paddingLEN, paddingCHAR)
            Me.cboDentalCode.Text = FormatText((dentalCodePrefix + nextDentalCode).Trim(), "DentalServices", "DentalCode")
