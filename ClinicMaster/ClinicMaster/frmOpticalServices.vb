...
Public Class frmOpticalServices
...
#End Region
    ...
    Private Sub frmOpticalServices_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

        Try
            Me.Cursor = Cursors.WaitCursor()

            ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            LoadLookupDataCombo(Me.cboOpticalCategoryID, LookupObjects.OpticalCategory, False)
    ...
    Private Sub cboOpticalCode_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboOpticalCode.TextChanged
        Me.CallOnKeyEdit()
    End Sub

    Private Sub cboOpticalCode_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboOpticalCode.Leave

        Try

            Dim opticalCode As String = SubstringRight(StringMayBeEnteredIn(Me.cboOpticalCode)).ToUpper()
            Me.cboOpticalCode.Text = OpticalCode.ToUpper()
            ...
            For Each row As DataRow In OpticalServices.Select("OpticalCode = '" + OpticalCode + "'")
                Me.stbOpticalName.Text = StringMayBeEnteredIn(row, "OpticalName")
            Next
    ...
    Private Sub LoadOpticalServices(ByVal populate As Boolean)
        ...
        Try
            ...
            ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            If populate Then
                LoadComboData(Me.cboOpticalCode, OpticalServices, "OpticalFullName")
            Else : Me.cboOpticalCode.Items.Clear()
            End If
            ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
    ...
    Private Sub fbnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles fbnDelete.Click
        ...
        Try
            ...
            oOpticalServices.OpticalCode = SubstringRight(RevertText(StringEnteredIn(Me.cboOpticalCode, "Optical Code!")))

            DisplayMessage(oOpticalServices.Delete())
            ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
    ...
    Private Sub fbnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles fbnSearch.Click
        ...
        Try
            ...
            Dim opticalCode As String = SubstringRight(RevertText(StringEnteredIn(Me.cboOpticalCode, "Optical Code!")))
            Dim dataSource As DataTable = oOpticalServices.GetOpticalServices(opticalCode).Tables("OpticalServices")
            Me.DisplayData(dataSource)

            Me.LoadBillCustomFee(opticalCode)
            Me.LoadInsuranceCustomFee(opticalCode)
    ...
    Private Sub ebnSaveUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ebnSaveUpdate.Click
        ...
        Dim itemCode As String = SubstringRight(RevertText(StringEnteredIn(Me.cboOpticalCode, "Optical Code!"))).ToUpper()
        Dim itemCategoryID As String = oItemCategoryID.Optical
        Try
            Me.Cursor = Cursors.WaitCursor()

            Dim oOpticalServices As New SyncSoft.SQLDb.OpticalServices()
            Dim lOpticalServices As New List(Of DBConnect)

            With oOpticalServices

                .OpticalCode = itemCode
                .OpticalName = StringEnteredIn(Me.stbOpticalName, "Optical Name!")
                .OpticalCategoryID = StringValueEnteredIn(Me.cboOpticalCategoryID, "Optical Category!")
                .UnitPrice = Me.nbxUnitPrice.GetDecimal(False)
                .UnitCost = DecimalMayBeEnteredIn(Me.nbxUnitCost, False)
            ...
            '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            lOpticalServices.Add(oOpticalServices)

            '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            If oOpticalServices.Hidden.Equals(True) Then
                Dim message As String = "You have chosen to hide this Optical Service and won’t be presented for selection. " +
            ...
            OpenBillableMappings(ebnSaveUpdate.ButtonText, oItemCategoryID.Optical, itemCode)
            ...
            Select Case Me.ebnSaveUpdate.ButtonText
                ...
                Case ButtonCaption.Save
                    ...
                    '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
                    transactions.Add(New TransactionList(Of DBConnect)(lOpticalServices, Action.Save))
                ...
                Case ButtonCaption.Update
                    ...
                    transactions.Add(New TransactionList(Of DBConnect)(lOpticalServices, Action.Update, "OpticalServices"))
                    transactions.Add(New TransactionList(Of DBConnect)(BillCustomFeeList, Action.Save))
                    transactions.Add(New TransactionList(Of DBConnect)(InsuranceCustomFeeList, Action.Save))
    ...
    Private Function BillCustomFeeList() As List(Of DBConnect)
        ...
        Try
            ...
            Dim itemCode As String = RevertText(StringEnteredIn(Me.cboOpticalCode, "Optical Code!"))
...
#Region " BillCustomFee - Grid "
    ...
    Private Sub LoadBillCustomFee(ByVal itemCode As String)
        ...
        Try
            ...
            Dim billCustomFee As DataTable = oBillCustomFee.GetBillCustomFee(itemCode, oItemCategoryID.Optical).Tables("BillCustomFee")
...
#Region " InsuranceCustomFee - Grid "
    ...
    Private Sub LoadInsuranceCustomFee(ByVal itemCode As String)
        ...
        Try
            ...
            Dim insuranceCustomFee As DataTable = oInsuranceCustomFee.GetInsuranceCustomFee(itemCode, oItemCategoryID.Optical).Tables("InsuranceCustomFee")
...
#Region " Edit Methods "
    ...
    Public Sub Save()
        ...
        Me.cboOpticalCode.MaxLength = 20
        Me.LoadOpticalServices(False)
        ...
        ResetControlsIn(Me.tpgInsuranceCustomFee)
        Me.SetNextOpticalID()
        Me.cboOpticalCode.Enabled = Not InitOptions.OpticalCodeLocked
    End Sub
...
#Region " SET AUTONUMBERS"
    ...
    Private Sub SetNextOpticalID()
        ...
        Try
            ...
            Dim autoNumbers As DataTable = oAutoNumbers.GetAutoNumbers("OpticalServices", "OpticalCode").Tables("AutoNumbers")
            Dim row As DataRow = autoNumbers.Rows(0)

            Dim paddingLEN As Integer = IntegerEnteredIn(row, "PaddingLEN")
            Dim paddingCHAR As Char = CChar(StringEnteredIn(row, "PaddingCHAR"))

            Dim OpticalCodePrefix As String = oVariousOption.OpticalCodePrefix
            Dim nextOpticalCode As String = CStr(oOpticalServices.GetNextOpticalID).PadLeft(paddingLEN, paddingCHAR)
            Me.cboOpticalCode.Text = FormatText((OpticalCodePrefix + nextOpticalCode).Trim(), "OpticalServices", "OpticalCode")
